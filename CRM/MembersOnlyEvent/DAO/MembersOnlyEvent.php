 ...
 *
 * Generated from
 *   uk.co.compucorp.membersonlyevent/xml/schema/CRM/MembersOnlyEvent/MembersOnlyEvent.xml
...
class CRM_MembersOnlyEvent_DAO_MembersOnlyEvent extends CRM_Core_DAO {
  ...
  /**
   * Notice message to show to the user when the access to members-only event
   * denied.
   *
   * @var text
   */
