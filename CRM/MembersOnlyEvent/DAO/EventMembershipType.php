 ...
 *
 * Generated from
 *   uk.co.compucorp.membersonlyevent/xml/schema/CRM/MembersOnlyEvent/EventMembershipType.xml
 *   DO NOT EDIT.  Generated by CRM_Core_CodeGen
 * (GenCodeChecksum:d3c26363c4e1bc3b562fc3ae1d19e526)
 */
...
class CRM_MembersOnlyEvent_DAO_EventMembershipType extends CRM_Core_DAO {
  ...
  public static function getEntityTitle() {
    return ts('Event Membership Types');
  }
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'membership_type_id' => [
          ...
          'type' => CRM_Utils_Type::T_INT,
          'title' => CRM_MembersOnlyEvent_ExtensionUtil::ts('Membership Type ID'),
          'description' => CRM_MembersOnlyEvent_ExtensionUtil::ts('Allowed Membership Type ID.'),
          'required' => TRUE,
